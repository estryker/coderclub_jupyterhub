...
c.JupyterHub.ssl_key = '/etc/letsencrypt/live/www.coderclub.us/privkey.pem'
c.JupyterHub.ssl_cert = '/etc/letsencrypt/live/www.coderclub.us/fullchain.pem'
...
#c.Authenticator.whitelist = {'me', 'myself', 'I'}
#c.Authenticator.admin_users = {'me', 'myself'}
...
c.Application.log_level = "DEBUG" # 30
...
# testing:
c.Spawner.container_image = "jupyterhub/singleuser_ruby"
